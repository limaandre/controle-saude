...
abstract class <?php echo $this->baseModelClass; ?> extends <?php echo $this->baseClass; ?> {
    ...
    <?php foreach($columns as $column): if($column->dbType == 'varchar(120)' || $column->dbType == 'varchar(130)'): ?>
public $<?=$column->name?>_delete;
	...
	public static function label($n = 1) {
		return Yii::t('app', '<?php echo $modelLables ; ?>', $n);
	}
...
<?php else: ?>
		return array('<?php echo $representingColumn; ?>');
<?php endif; ?>
	}
