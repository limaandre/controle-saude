 ...
 * <li><code>public/views/system</code></li>
...
class CErrorHandler extends CApplicationComponent
{
	 ...
	 */
	public function getExactTrace($exception)
	{
	 ...
	 */
	public function getViewFile($view,$code)
	{
		$viewPaths=array(
	 ...
	 * @return string view file path
	 */
	public function getViewFileInternal($viewPath,$view,$code,$srcLanguage=null)
	{
		$app=Yii::app();
		if($view==='error')
		{
